...
test('connections: settings are read, saved to config, applied live; sign-in streams for browser CLIs and hands a command to the others', async () => {
  ...
  try {
    ...
    assert.deepEqual({ ...saved.body.settings, timeouts: undefined, capabilities: undefined, memory: undefined }, {
      timeouts: undefined, capabilities: undefined, memory: undefined, defaultTimeout: 240000, delegation: false, maxPlanSteps: 2, softTokenBudget: 750000, opencodeModel: 'openai/gpt-5.6-sol', geminiIdleMs: 60000, geminiRetries: 2,
    });
