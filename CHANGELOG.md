...
- Cada turno, MADRE escribe un documento en tu nombre y se lo entrega a un proceso. Hasta hoy ese documento **existía solo el instante en que el proceso lo leía**: no se guardaba en ninguna parte y nadie había leído uno nunca. Ni tú. Se entra haciendo clic en **MADRE**.
...
- Y se siente como entrar dentro del sol: el campo arde desde los bordes y respira, con la consola en fósforo encima. Nada de eso es un idioma nuevo — el marco, los pliegues, las barras y la letra son los que MADRE ya habla. Quien pidió menos movimiento no lo ve respirar.
