...
- La leyenda de NOSTROMO muestra la estrella, no una muestra de color. Cada chip trae una enana dibujada con el mismo suelo, la misma cara hirviendo y el mismo limbo que las de la constelación, junto al nombre de su clase y el tipo de memoria que arde así. La tipografía es la misma de la cabecera.
